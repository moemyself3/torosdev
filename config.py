...
class Configuration:
    ...
    SUBTRACT_SKY    = "Y"
    PLATE_SOLVE     = "Y"
    PLATE_SOLVE_METHOD = "astrometry_net"
    SOURCE_EXTRACTOR_PATH = "/opt/homebrew/bin/sex"
    ...
    CUTOUT_DIRECTORY = DATA_DIRECTORY + "cutout/"
    CUTOUT_FIELD_DIRECTORY = CUTOUT_DIRECTORY + FIELD + "/"
    CUTOUT_CLEAN_DIRECTORY = CUTOUT_FIELD_DIRECTORY + "clean/"
    CUTOUT_DIFF_DIRECTORY = CUTOUT_FIELD_DIRECTORY + "diff/"
    CUTOUT_MASTER_DIRECTORY = CUTOUT_FIELD_DIRECTORY + "master/"
    TRAINING_DIRECTORY = DATA_DIRECTORY + "training/"
    EPSF_DIRECTORY = DATA_DIRECTORY + "epsf/"
    EPSF_MODELS_DIRECTORY = EPSF_DIRECTORY + "models/"
    EPSF_CANDIDATES_DIRECTORY = EPSF_DIRECTORY + "candidates/"
    INJECTED_DATA_DIRECTORY = TRAINING_DIRECTORY + "injected/"
    INJECTED_CLEAN_DIRECTORY = INJECTED_DATA_DIRECTORY + "clean/"
    INJECTED_DIFF_DIRECTORY = INJECTED_DATA_DIRECTORY + "diff/"
    INJECTED_FLUX_DIRECTORY = INJECTED_DATA_DIRECTORY + "flux/"
    INJECTED_CATALOG_DIRECTORY = INJECTED_DATA_DIRECTORY + "catalogs/"
    INJECTED_REALBOGUS_CATALOG_DIRECTORY = INJECTED_DATA_DIRECTORY + "rb_catalogs/"
    DIFFERENCED_CATALOG_DIRECTORY = DATA_DIRECTORY + "diff_catalogs/"
    REALBOGUS_CATALOG_DIRECTORY = DATA_DIRECTORY + "rb_catalogs/"
    CLASSIFICATION_RF_DIRECTORY = DATA_DIRECTORY + "class_rf/"
    CLASSIFICATION_CNN_DIRECTORY = DATA_DIRECTORY + "class_cnn/"

    # directory_list
    DIRECTORIES = [ANALYSIS_DIRECTORY, DATA_DIRECTORY, LOG_DIRECTORY,
                   CALIBRATION_DIRECTORY, FLUX_DIRECTORY, QUERIES_DIRECTORY,
                   CLEAN_DIRECTORY, MASTER_MAIN_DIRECTORY, MASTER_DIRECTORY,
                   MASTER_TMP_DIRECTORY, LIGHTCURVE_DIRECTORY,
                   CENTROID_DIRECTORY, RAW_DIRECTORY, BIAS_DIRECTORY,
                   DARK_DIRECTORY, FLAT_DIRECTORY, DIFFERENCED_DIRECTORY,
                   CODE_DIFFERENCE_DIRECTORY, LIGHTCURVE_FIELD_DIRECTORY,
                   REVIEW_DIRECTORY, CUTOUT_DIRECTORY, CUTOUT_FIELD_DIRECTORY,
                   CUTOUT_CLEAN_DIRECTORY, CUTOUT_DIFF_DIRECTORY,
                   CUTOUT_MASTER_DIRECTORY, TRAINING_DIRECTORY,
                   INJECTED_DATA_DIRECTORY, INJECTED_CLEAN_DIRECTORY,
                   INJECTED_DIFF_DIRECTORY, INJECTED_FLUX_DIRECTORY,
                   INJECTED_CATALOG_DIRECTORY, INJECTED_REALBOGUS_CATALOG_DIRECTORY,
                   DIFFERENCED_CATALOG_DIRECTORY, REALBOGUS_CATALOG_DIRECTORY,
                   CLASSIFICATION_RF_DIRECTORY, CLASSIFICATION_CNN_DIRECTORY,
                   ]
